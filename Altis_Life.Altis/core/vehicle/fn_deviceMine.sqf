...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","rye_1","hops_1","yeast_1","phosphorous_1","ephedra_1","frog_swamp1","gold_1","platinum_1"];
_zone = "";
...
_item = switch(true) do {
    ...
    case (_zone in ["phosphorous_1"]): {"phosphorous"};
    case (_zone in ["ephedra_1"]): {"ephedra"};
    case (_zone in ["frog_swap"]): {"frog"};
    case (_zone in ["gold_1"]): {"gold"};
    case (_zone in ["platinum_1"]): {"platinum"};
	default {""};
};
