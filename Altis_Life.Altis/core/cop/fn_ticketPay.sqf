...
if(life_dosh < life_ticket_val) exitWith
{
	if(life_rupees < life_ticket_val) exitWith 
	{
	...
	life_rupees = life_rupees - life_ticket_val;
...
life_dosh = life_dosh - life_ticket_val;
life_ticket_paid = true;
