...
_Btn3 buttonSetAction "[life_pInact_curTarget] call life_fnc_arrestAction;";

_Btn4 ctrlSetText localize "STR_pInAct_Unrestrain";
_Btn4 buttonSetAction "[life_pInact_curTarget] call life_fnc_unrestrain; closeDialog 0;";

if(!license_civ_bountyhunter) then {
	_Btn3 ctrlShow false;
    _Btn4 ctrlShow false;
};

if(!((player distance (getMarkerPos "police_jail") < 30))) then 
{
