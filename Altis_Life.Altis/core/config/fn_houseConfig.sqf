...
*/
switch (true) do {
	case (_house in ["Land_i_House_Big_02_V1_F","Land_i_House_Big_02_V2_F","Land_i_House_Big_02_V3_F"]): {[1750000,3]};
	...
	case (_house in ["Land_i_House_Small_03_V1_F"]): {[1750000,3]};
