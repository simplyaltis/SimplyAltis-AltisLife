...
{
	case 0: {life_donDis = 1.0;};
	case 1: {life_donDis = 0.95; life_paycheck = life_paycheck + 500;};
	case 2: {life_donDis = 0.90; life_paycheck = life_paycheck + 750;};
	case 3: {life_donDis = 0.85; life_paycheck = life_paycheck + 1000;};
	case 4: {life_donDis = 0.75; life_paycheck = life_paycheck + 2000;};
    case 5: {life_donDis = 0.75; life_paycheck = life_paycheck + 2000;};
};
...
[] execVM "core\fn_welcomeText.sqf";
