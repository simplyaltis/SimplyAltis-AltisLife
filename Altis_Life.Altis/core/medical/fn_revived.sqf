...
if(life_rupees > (call life_revive_fee)) then {
...
switch(playerSide) do {
	case independent: {[[player,0,"textures\clothing\medic_uniform.jpg"],"life_fnc_setTexture",true,false] spawn life_fnc_MP;};
};
