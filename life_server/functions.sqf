...
compileFinal "
	...
	[[life_rupees,life_dosh,owner player,player],""life_fnc_admininfo"",_ret,false] spawn life_fnc_MP;
";
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 2 :
		{
			if((call life_bondlevel) < 1) exitWith {};
			private[""_message""];
		...
		case 3 :
		{
			...
			systemChat _message;
			if((call life_bondlevel) > 0) then {systemChat _admin;};
		};
